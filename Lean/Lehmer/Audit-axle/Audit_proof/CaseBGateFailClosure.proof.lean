-- FILE: Lean/Lehmer/Audit-axle/Audit_proof/CaseBGateFailClosure.proof.lean
import Mathlib
...
theorem false_of_caseCClosure
    ...
    False := by
  exact false_of_caseCClosure_external I
...
theorem false_of_AuditCaseBGateFailState_via_caseC
    ...
    (I : CaseBGateFailToCaseCBridgeInput C) :
    False := by
  exact false_of_caseCClosure
    Context
    CaseBGateFailToCaseCBridgeInput
    false_of_caseCClosure_external
    I
...
theorem caseBGateFailClosure_of_state
    ...
    (I : CaseBGateFailToCaseCBridgeInput C) :
    False := by
  exact false_of_AuditCaseBGateFailState_via_caseC
    Context
    AuditCaseBGateFailState
    CaseBGateFailToCaseCBridgeInput
    false_of_caseCClosure_external
    hC
    I