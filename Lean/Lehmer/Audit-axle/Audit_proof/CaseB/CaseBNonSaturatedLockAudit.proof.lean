-- FILE: Lean/Lehmer/Audit-axle/Audit_proof/CaseB/CaseBNonSaturatedLockAudit.proof.lean
import Mathlib
...
theorem exists_discharge_or_entangled_lockRouting_of_state
  ...
  exact discharge_or_entangled_lockRouting_of_state C hC
...
theorem exists_caseBNonSaturatedLockAssembly_of_branch
  ...
  exact Exists.intro
    (caseBNonSaturatedLockAssembly_of_branch B)
    True.intro
...
theorem exists_genericChainToSSLock_of_auditCaseBNonSaturatedBranch
  ...
  exact Exists.intro
    (genericChainToSSLock_of_auditCaseBNonSaturatedBranch B)
    True.intro