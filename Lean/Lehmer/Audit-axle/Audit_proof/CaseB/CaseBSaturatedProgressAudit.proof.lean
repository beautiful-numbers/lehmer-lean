-- FILE: Lean/Lehmer/Audit-axle/Audit_proof/CaseB/CaseBSaturatedProgressAudit.proof.lean
import Mathlib
...
theorem AuditCaseBSaturatedLocalOutcome_of_gatePassState
    ...
    AuditCaseBSaturatedLocalOutcome
      ...
      C := by
  exact Or.inl
    (Exists.intro (auditCaseBGatePassData_of_state C hC) True.intro)
...
theorem AuditCaseBSaturatedLocalOutcome_of_gateFailState
    ...
    AuditCaseBSaturatedLocalOutcome
      ...
      C := by
  exact Or.inr
    (Exists.intro (auditCaseBGateFailData_of_state C hC) True.intro)
...
theorem AuditCaseBSaturatedLocalOutcome_of_saturatedState
    ...
    AuditCaseBSaturatedLocalOutcome
      ...
      AuditCaseBGateFailData
      C := by
  exact saturatedLocalOutcome_of_saturatedState hC
...
theorem exists_gatePass_or_gateFail_of_saturatedState
  ...
  exact saturatedLocalOutcome_of_saturatedState C hC
...
theorem exists_gatePass_of_state
  ...
  exact Exists.intro
    (auditCaseBGatePassData_of_state C hC)
    True.intro
