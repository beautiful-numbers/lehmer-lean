-- FILE: Lean/Lehmer/Audit-axle/Audit_proof/CaseC/ClosureData.proof.lean
import Mathlib
...
theorem auditCaseCClosureDataAvailable
    ...
    AuditCaseCClosureDataAvailable
      ...
      auditCaseCClosureDataDataOf
      hC := by
  exact Nonempty.intro (auditCaseCClosureDataDataOf hC)
